...
export async function execute(interaction) {
    ...
    if (interaction.options.getSubcommand() === 'player') {
        ...
        if (presenceType === 0) { presenceType = "Offline."; color = 10066329; }
        else if (presenceType === 1) { presenceType = "On the website."; color = 51711; }
        else if (presenceType === 2) { presenceType = "Playing."; color = 65280; }
        else if (presenceType === 3) { presenceType = "Building in Studio."; color = 16748544; }
        else if (presenceType === 4) { presenceType = "Invisible."; color = 10066329; };
